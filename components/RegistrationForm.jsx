    ...
    const validateForm = () => {
        ...
        members.forEach(member => {
            ...
            if (!member.phone.trim()) {
                ...
                isValid = false;
            } else if (!/^[0-9]{10}$/.test(member.phone)) {
        ...
        <div className='md:w-[75%] w-full rounded-xl bg-white overflow-y-scroll h-full'>
            ...
            >
                <section>
                    ...
                    <div className='mt-10'>
                        ...
                        <input
                            ...
                            className={`mt-2.5 block w-full rounded-md px-3.5 py-2 text-base outline-1 -outline-offset-1 ${errors.teamName ? 'outline-red-500' : 'outline-gray-300'} placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-black`}
                            required
                        />
              ...
              <span
                            ...
                            <div key={member.id} className='flex flex-col mb-5 pb-10'>
                                ...
                                <div className='mb-4'>
                                    ...
                                    <input
                                        ...
                                        className={`mt-2.5 block w-full rounded-md px-3.5 py-2 text-base outline-1 -outline-offset-1 ${errors[`member-${member.id}-name`] ? 'outline-red-500' : 'outline-gray-300'} placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-black`}
                                        required
                                    />
                                    {errors[`member-${member.id}-name`] &&
                                        <p className="text-red-500 text-sm mt-1">{errors[`member-${member.id}-name`]}</p>}
                                </div>
                                <div className='mb-4'>
                                    <label
                                    ...
                                    <input
                                        ...
                                        className={`mt-2.5 block w-full rounded-md px-3.5 py-2 text-base outline-1 -outline-offset-1 ${errors[`member-${member.id}-email`] ? 'outline-red-500' : 'outline-gray-300'} placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-black`}
                                        required
                                    />
                                    {errors[`member-${member.id}-email`] &&
                                        <p className="text-red-500 text-sm mt-1">{errors[`member-${member.id}-email`]}</p>}
                                </div>
                                <div className='mb-4'>
                                    <label
                                ...
                                <div className='mb-4'>
                                    ...
                                    <input
                                        ...
                                        className={`mt-2.5 block w-full rounded-md px-3.5 py-2 text-base outline-1 -outline-offset-1 ${errors[`member-${member.id}-phone`] ? 'outline-red-500' : 'outline-gray-300'} placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-black`}
                                        required
                                        placeholder="10-digit number"
                                    />
                                    {errors[`member-${member.id}-phone`] &&
                                        <p className="text-red-500 text-sm mt-1">{errors[`member-${member.id}-phone`]}</p>}
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <button
                    type='submit'
                    className={`mt-10 block w-full rounded-md px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-xs ${loading ? 'bg-gray-600 cursor-not-allowed' : 'bg-black hover:bg-neutral-800'}`}
                    disabled={loading}
                >
