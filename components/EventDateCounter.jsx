export default function EventDateCounter() {
    ...
    const eventDate = new Date("2025-03-31T00:00:00");
    const now = new Date();
        ...
        <div className="w-full max-w-xs p-4 bg-gray-50 rounded-xl border border-gray-100 mb-6">
            <div className="flex items-center justify-center gap-2 text-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-600" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <path fillRule="evenodd" d="M10 4a1 1 0 011 1v4.586l2.707 2.707a1 1 0 01-1.414 1.414l-3-3a1 1 0 01-.293-.707V5a1 1 0 011-1z" clipRule="evenodd" />
                </svg>
