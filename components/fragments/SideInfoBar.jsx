...
const SideInfoBar = () => {
  ...
  return (
    <div className="md:w-[350px] w-full h-full p-4 bg-white rounded-xl flex flex-col">
      <div className="-mt-2">
        ...
        <div className="mt-2">
          <p className={`text-sm font-medium text-neutral-500 transition-all duration-300 leading-7 line-clamp-5`}>
            Get ready to ignite your coding passion! Konnexions is rolling out the red carpet for the epic hackathon experience, Kodessphere. Prepare
            to dive into a whirlwind of innovation, teamwork, and the latest tech marvels. Whether you're a coding wizard or a rising star, seize this
            moment to dazzle and redefine the digital landscape. Don't let this opportunity slip through your fingertips! Secure your spot now
            —register fast!
          </p>
          {/* Read More Button */}
