        ...
        {!isMobile && (
          <div className="flex flex-col items-center justify-center px-5 py-4 border-b border-gray-200">
            ...
            <div className="flex flex-col items-center w-full space-y-4">
              ...
              <div className="flex items-center justify-center h-16 -mt-6 overflow-hidden transition-colors duration-300 bg-white rounded-sm w-50">
                <Image
          ...
          <div className="mb-6">
            ...
            <nav className="space-y-1">
              {navigationLinks.map((link) => (
                <Link href={link.path} key={link.name} className="block" onClick={() => setIsOpen(false)}>
