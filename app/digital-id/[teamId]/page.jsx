...
const page = () => {
    ...
    return (
        <div
            className={`${spaceGrotesk.className} flex min-h-screen flex-wrap items-center justify-center gap-10 bg-gray-200 p-2`}>
            {participants && participants?.map((participant) => (<div key={participant.UserId}
                                                                      className="w-[380px] md:w-[280px] relative pointer-events-none select-none p-0">
